...
import { X, Loader2, ListMusic, Zap, Mic2, Music2 } from 'lucide-react'
...
export default function NewSessionModal({ onClose, onCreate }: Props) {
  ...
  async function handleCreate(e: React.FormEvent) {
    ...
    if (sessionType === 'dj') {
      ...
      body = { ...body, price_normal: pNormal, price_priority: pPriority }
    } else {
      ...
      <div className="w-full max-w-md bg-gray-900 border border-white/10 rounded-3xl p-6 space-y-5 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleCreate} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <p className="text-gray-500 text-xs mt-0.5">Demandes de sons + pourboires</p>
              </button>
              <button
                type="button"
              ...
              >
                ...
                <p className="text-gray-500 text-xs mt-0.5">File d&apos;attente pour chanter</p>
              </button>
            </div>
          </div>
          ...
          >
            ...
            {sessionType === 'karaoke' ? 'Démarrer le karaoké 🎤' : 'Démarrer la soirée 🎧'}
          </button>
        </form>
      </div>
    </div>
